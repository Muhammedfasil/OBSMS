<?php
  ...
  if (isset($_POST['submit'])) 
  {
   ...
   $demo=mysqli_query($con,"SELECT * FROM faculty_details WHERE email='$email' and password='$pass' ");
   $row=mysqli_fetch_array($demo);
    ...
    {
     echo "<script>window.location.href='lockscreen.php'</script>";
    }
  }
?>
<!DOCTYPE html>
